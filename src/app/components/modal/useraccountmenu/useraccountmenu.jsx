  ...
  return (
    <div className="fixed inset-0 md:top-[10.7%] top-20 left-0 bg-[#95959599] z-50 transition-all duration-300">
      <div className="bg-white absolute top-0 md:right-50 right-0 p-4 md:rounded-2xl rounded-b-3xl flex flex-col md:w-[330px] max-w-[300px]">
        <div className="flex gap-5 items-center border-b border-[var(--light-3)] pb-2">
          <div>
            <Image
              ...
              height={40}
              alt="user-avatar"
              className="border-2 border-[var(--primary-100)] rounded-full"
            />
          </div>
          <div>
        ...
        <button className="flex gap-2 mt-4 cursor-pointer">
          <svg
            ...
            strokeWidth="1.5"
            stroke="currentColor"
            className="size-6 text-[var(--light-1)]"
          >
            <path
              strokeLinecap="round"
          ...
          <h6 className="text-[var(--gray-3)]">My profile</h6>
        </button>
        ...
        <button className="flex gap-2 mt-4 cursor-pointer">
          ...
          <h6 className="text-[var(--gray-3)]">My brands and organizations</h6>
        </button>
